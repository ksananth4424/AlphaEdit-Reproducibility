...
from util.device import get_model_input_device, get_module_device
...
def compute_z(
    ...
    layer_device = get_module_device(model, hparams.layer_module_tmp.format(layer))
    ...
    if hasattr(model.config, 'n_embd'):
        delta = torch.zeros((model.config.n_embd,), requires_grad=True, device=layer_device)
